...
let directional1 = new T.DirectionalLight("blue", 1);
directional1.position.set(1, 1, 1);
scene.add(directional1);

let directional2 = new T.DirectionalLight("red", 1);
directional2.position.set(-1, 1, -1);
scene.add(directional2);

let directional3 = new T.DirectionalLight("green", 1);
directional3.position.set(1, 1, -1);
scene.add(directional3);

let directional4 = new T.DirectionalLight("yellow", 1);
directional4.position.set(-1, 1, 1);
